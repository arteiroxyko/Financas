...
$qr=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano'");
$row=mysql_fetch_array($qr);
$saidas=$row['total'];

$resultado_mes=$entradas-$saidas;

$qr=mysql_query("SELECT * FROM smovimentos WHERE conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano' ORDER By dia");
$cont=0;
...
//calculo da fatura
$qr=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo='0' && conta='$conta' && usuario='$usuario' && mes='$mes' && ano='$ano'");
$row=mysql_fetch_array($qr);
$saidas=$row['total'];
...
$qrvf=mysql_query("SELECT * FROM smovimentos WHERE conta='$conta' && usuario='$usuario' && mes='$mes' && ano='$ano' ORDER By dia");
...
$qr=mysql_query("SELECT * FROM smovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && mes='$mes' && ano='$ano' ORDER By dia");
$cont=0;
while ($row=mysql_fetch_array($qr)){
$cont++;
