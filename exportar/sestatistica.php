...
$qrv=mysql_query("SELECT * FROM smovimentos WHERE conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano' ORDER By dia");
if (mysql_num_rows($qrv)!==0){

$qrg=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo=1 && conta=1 && usuario='$usuario'");
$rowg=mysql_fetch_array($qrg);
$entradasg=$rowg['total'];

$qrg=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta=1 && usuario='$usuario'");
$rowg=mysql_fetch_array($qrg);
$saidasg=$rowg['total'];
...
$qr=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo=1 && conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano'");
$row=mysql_fetch_array($qr);
$entradas=$row['total'];

$qrs=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano'");
...
$qre=mysql_query("SELECT dia, cat, SUM(valor) as total FROM smovimentos WHERE tipo=1 && conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano' GROUP BY cat ORDER BY dia");
...
//Estáticas de saídas
$qrs=mysql_query("SELECT dia, cat, SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano' GROUP BY cat ORDER BY dia");
...
$qrv=mysql_query("SELECT * FROM smovimentos WHERE conta=1 && usuario='$usuario' && ano='$ano' ORDER By dia");
if (mysql_num_rows($qrv)!==0){

$qr=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo=1 && conta=1 && usuario='$usuario' && ano='$ano'");
$row=mysql_fetch_array($qr);
$entradas=$row['total'];
$entradastotal=formata_dinheiro($entradas);

$qrs=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta=1 && usuario='$usuario' && ano='$ano'");
$rows=mysql_fetch_array($qrs);
$saidas=$rows['total'];

$qror=mysql_query("SELECT SUM(valor) as total FROM sorcamento WHERE conta=1 && usuario='$usuario' && ano='$ano'");
...
//Estáticas de entradas
$qre=mysql_query("SELECT dia, cat, SUM(valor) as total FROM smovimentos WHERE tipo=1 && conta=1 && usuario='$usuario' && ano='$ano' GROUP BY cat ORDER BY dia");
...
$pdf->Cell(19,0.6,utf8_decode("Percentual por scategorias sobre receitas no total de $entradastotal"),'B',1,'C',1);
$pdf->SetFont('Arial','',12);
$pdf->Cell(12,0.6,'Categoria:',0,0,'L',1);
$pdf->Cell(4,0.6,'Valor:',0,0,'L',1);
$pdf->Cell(3,0.6,'Percentual:',0,1,'R',1);
...
//Estáticas de saídas
$qrs=mysql_query("SELECT dia, mes, cat, SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta=1 && usuario='$usuario' && ano='$ano' GROUP BY cat ORDER BY dia");
if(mysql_num_rows($qrs)!==0){
...
$qrv=mysql_query("SELECT * FROM smovimentos WHERE conta='$conta' && usuario='$usuario' && mes='$mes' && ano='$ano' ORDER By dia");
if (mysql_num_rows($qrv)!==0){

$qrs=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && mes='$mes' && ano='$ano'");
$rows=mysql_fetch_array($qrs);
$saidas=$rows['total'];

//Estáticas de saídas
$qrs=mysql_query("SELECT dia, cat, SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && mes='$mes' && ano='$ano' GROUP BY cat ORDER BY dia");
if(mysql_num_rows($qrs)!==0){
...
$qrv=mysql_query("SELECT * FROM smovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && ano='$ano' ORDER By dia");
if (mysql_num_rows($qrv)!==0){

$qrs=mysql_query("SELECT SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && ano='$ano'");
$rows=mysql_fetch_array($qrs);
$saidas=$rows['total'];

//Estáticas de saídas
$qrs=mysql_query("SELECT dia, cat, SUM(valor) as total FROM smovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && ano='$ano' GROUP BY cat ORDER BY dia");
if(mysql_num_rows($qrs)!==0){
...
$cat=$row['cat'];
$qr2=mysql_query("SELECT nome FROM scategorias WHERE id='$cat' ORDER BY nome");
$row2=mysql_fetch_array($qr2);
$categoria=$row2['nome'];
$valorcat=$row['total'];
$percento = @round (($valorcat/$saidas) * 100,1);
