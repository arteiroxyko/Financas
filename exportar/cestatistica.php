...
$qrs=mysql_query("SELECT SUM(valor) as total FROM cmovimentos WHERE tipo=0 && conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano'");
...
$qre=mysql_query("SELECT dia, cat, SUM(valor) as total FROM cmovimentos WHERE tipo=1 && conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano' GROUP BY cat ORDER BY dia");
...
//Estáticas de saídas
$qrs=mysql_query("SELECT dia, cat, SUM(valor) as total FROM cmovimentos WHERE tipo=0 && conta=1 && usuario='$usuario' && mes='$mes' && ano='$ano' GROUP BY cat ORDER BY dia");
...
$qrv=mysql_query("SELECT * FROM cmovimentos WHERE conta=1 && usuario='$usuario' && ano='$ano' ORDER By dia");
if (mysql_num_rows($qrv)!==0){

$qr=mysql_query("SELECT SUM(valor) as total FROM cmovimentos WHERE tipo=1 && conta=1 && usuario='$usuario' && ano='$ano'");
$row=mysql_fetch_array($qr);
$entradas=$row['total'];
$entradastotal=formata_dinheiro($entradas);

$qrs=mysql_query("SELECT SUM(valor) as total FROM cmovimentos WHERE tipo=0 && conta=1 && usuario='$usuario' && ano='$ano'");
$rows=mysql_fetch_array($qrs);
$saidas=$rows['total'];

$qror=mysql_query("SELECT SUM(valor) as total FROM corcamento WHERE conta=1 && usuario='$usuario' && ano='$ano'");
...
//Estáticas de entradas
$qre=mysql_query("SELECT dia, cat, SUM(valor) as total FROM cmovimentos WHERE tipo=1 && conta=1 && usuario='$usuario' && ano='$ano' GROUP BY cat ORDER BY dia");
...
//Estáticas de saídas
$qrs=mysql_query("SELECT dia, mes, cat, SUM(valor) as total FROM cmovimentos WHERE tipo=0 && conta=1 && usuario='$usuario' && ano='$ano' GROUP BY cat ORDER BY dia");
if(mysql_num_rows($qrs)!==0){
...
$qrv=mysql_query("SELECT * FROM cmovimentos WHERE conta='$conta' && usuario='$usuario' && mes='$mes' && ano='$ano' ORDER By dia");
if (mysql_num_rows($qrv)!==0){

$qrs=mysql_query("SELECT SUM(valor) as total FROM cmovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && mes='$mes' && ano='$ano'");
$rows=mysql_fetch_array($qrs);
$saidas=$rows['total'];

//Estáticas de saídas
$qrs=mysql_query("SELECT dia, cat, SUM(valor) as total FROM cmovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && mes='$mes' && ano='$ano' GROUP BY cat ORDER BY dia");
if(mysql_num_rows($qrs)!==0){
...
$qrv=mysql_query("SELECT * FROM cmovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && ano='$ano' ORDER By dia");
if (mysql_num_rows($qrv)!==0){

$qrs=mysql_query("SELECT SUM(valor) as total FROM cmovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && ano='$ano'");
$rows=mysql_fetch_array($qrs);
$saidas=$rows['total'];

//Estáticas de saídas
$qrs=mysql_query("SELECT dia, cat, SUM(valor) as total FROM cmovimentos WHERE tipo=0 && conta='$conta' && usuario='$usuario' && ano='$ano' GROUP BY cat ORDER BY dia");
if(mysql_num_rows($qrs)!==0){
...
$cat=$row['cat'];
$qr2=mysql_query("SELECT nome FROM ccategorias WHERE id='$cat' ORDER BY nome");
$row2=mysql_fetch_array($qr2);
$categoria=$row2['nome'];
$valorcat=$row['total'];
$percento = @round (($valorcat/$saidas) * 100,1);
